...
伦敦大学的学生
感想:
不像一般的游戏开发, 有时候要考虑到眼镜的局限性(3D眩晕:开发的游戏不能有大量镜头抖动+转换,玩家移动速度不能太大), 以及眼镜的特性(身临其境的感受, 感觉更爽,新奇,光影效果赞; 所以我们的游戏需要两个玩家互相配合,在紧张的游戏环境下体验互相配合的乐趣;而且我们的游戏除了射击打僵尸,还需要各种配合解谜,虽然现在有很多密室逃脱的真人体验游戏,但是现实中有局限,很多高难度的东西玩不了,玩家可能会受到伤害, 而且一些复杂的器械在现实中成本很高,但是在虚拟现实游戏中就不一样啦,只要想得到的就能做给你看,一些危险的解谜,毒气+激光+僵尸毫无压力,玩家可以尽情体验紧张刺激的游戏)
